...
use glium::{glutin, Surface, VertexBuffer, DrawParameters, Display, Program, uniforms};

mod support;

fn chunk_draw<T: Surface, S: uniforms::Uniforms>(target: &mut T, display: &Display, program: &Program, uniforms: &S, params: &DrawParameters) {
...
fn main() {
    ...
    support::start_loop(|| {
        ...
        chunk_draw(&mut target, &display, &program, &uniforms, &params);
